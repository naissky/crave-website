import { r as removeBase, i as isRemotePath, V as VALID_INPUT_FORMATS, A as AstroError, g as RenderUndefinedEntryError, U as UnknownContentCollectionError, p as prependForwardSlash } from './astro/assets-service_C-YPipwp.mjs';
import { c as createComponent, r as renderTemplate, u as unescapeHTML, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, a as renderComponent } from './astro/server_wY7ncS-m.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_ToRcNxXB.mjs').then(n => n._);
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/food/choco-bliss.md": () => import('./choco-bliss_C9bs-Y44.mjs'),"/src/content/food/cookie-mind.md": () => import('./cookie-mind_rfdusEf9.mjs'),"/src/content/food/lemon-zest.md": () => import('./lemon-zest_Cr81KBG5.mjs')});
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/food/choco-bliss.md": () => import('./choco-bliss_CMwVeEIh.mjs'),"/src/content/food/cookie-mind.md": () => import('./cookie-mind_BBCADvVs.mjs'),"/src/content/food/lemon-zest.md": () => import('./lemon-zest_Jck4CUL5.mjs')});
